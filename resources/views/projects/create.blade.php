    ...
    <div class="bg-white rounded-lg p-4 mx-auto max-w-lg shadow border border-gray-200">
        ...
        <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-5">
                ...
                <input type="text" name="project_name" class="w-full text-sm px-3 py-2 rounded-md" />
            </div>

            <div class="mb-5">
                <label for="client-name" class="block mb-2 font-medium">Client Name</label>
                <input type="text" name="client" class="w-full text-sm px-3 py-2 rounded-md" />
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="number" name="progress" class="w-full text-sm px-3 py-2 rounded-md" min="0"
                    max="100">
            </div>
            ...
            <div class="flex gap-2 justify-end mb-1">
                ...
                <button type="submit"
                    class="px-4 py-3 rounded-lg text-white font-medium cursor-pointer bg-blue-500 hover:bg-blue-600">Submit</button>
            </div>
